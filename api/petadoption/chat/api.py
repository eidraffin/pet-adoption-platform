...
def conversations_list(request):
    #list of conversations for the requesting user
...
def conversations_detail(request, pk):
    #retrieve and serialize details of a specific conversation for the requesting user
...
def conversations_start(request, user_id):
    #start a new conversation or retrieve an existing one with another user
    ...
    if conversations.count() > 0:
        ...
        #if conversation doesn't exist, create a new one and add users
